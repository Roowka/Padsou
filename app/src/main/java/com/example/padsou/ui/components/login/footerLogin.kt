...
@Composable
fun footerLogin(navController: NavHostController){
    Column(modifier = Modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
        Row(modifier = Modifier.padding(top = 30.dp, bottom = 30.dp)){
            ...
            Text(text = "Allez viens !", color = Purple1, modifier = Modifier.padding(start = 2.dp).clickable { navController.navigate("register") }, fontSize = 12.sp)
        }
    }
}